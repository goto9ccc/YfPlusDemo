...
{$IFDEF DESIGNTIME}
{$IFDEF EH_LIB_6}
  with TRegIniFile.Create(ActiveDesigner.Environment.GetBaseRegKey + '\' + LibraryRegKey) do
{$ELSE}
  with TRegIniFile.Create(DelphiIDE.GetBaseRegKey + '\' + LibraryRegKey) do
{$ENDIF}
  try
