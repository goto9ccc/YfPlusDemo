...
uses
  SysUtils, Classes,Base_Module, DB, ADODB;
...
function TModuleLogin.checkLogin(UserName, PassWord: String): Boolean;
var
...
function TModuleLogin.Decode7(EnStr, s: string): string;
...
function TModuleLogin.Encode7(EnStr, s: string): string;
var i,n2:integer;
...
function TModuleLogin.EnUser(s: String): string;
var n,i,d:integer;
begin
  Result := '' ;
  i := length(s) ;
